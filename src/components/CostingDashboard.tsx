...
export default function CostingDashboard() {
  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-in fade-in duration-500 pb-20 sm:pb-0">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 bg-white/95 backdrop-blur-md px-5 py-3 sm:px-8 sm:py-5 rounded-[2rem] sm:rounded-[3rem] border border-slate-100 sm:border-white shadow-sm sticky top-[60px] sm:top-[70px] lg:top-[110px] z-40 transition-all duration-300">
